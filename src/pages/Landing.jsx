...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section ref={formularioRef} className="min-h-screen bg-white flex items-center">
        <div className="max-w-7xl mx-auto w-full grid md:grid-cols-2 gap-8 lg:gap-12 px-4 sm:px-6 lg:px-8">
          {/* Lado Esquerdo - Imagem */}
          <motion.div
            initial={{ opacity: 0, x: -30 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8 }}
            className="hidden md:block relative h-screen md:h-auto md:min-h-[600px] rounded-2xl overflow-hidden"
          >
            <img
          ...
          >
            <div className="mb-12">
              ...
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-heading text-brown-dark leading-tight mb-4">
                A forma mais inteligente de conquistar
                <span className="text-brown-caramel"> seu consórcio</span>
              </h1>
              <p className="text-base md:text-lg font-body text-brown-medium/80">
                Sem juros, sem surpresas. Apenas estratégia patrimonial.
              </p>
            </div>

            <div className="bg-brown-sand/50 rounded-2xl p-6 md:p-8 border border-brown-caramel/10">
              <h2 className="text-2xl font-heading text-brown-dark mb-6">
